...
curl --ftp-create-dirs -T  /feedstock_root/build_artefacts/linux-ppc64le/${1}*.tar.bz2 -u $FTP_USER:$FTP_PASSWORD  ftp://ausgsa.ibm.com/gsa/ausgsa/projects/c/condapower/linux-ppc64le/
